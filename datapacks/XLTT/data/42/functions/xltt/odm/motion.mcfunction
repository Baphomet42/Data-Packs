...
execute store result score @e[tag=42.odm_marker,tag=42.xltt_id,limit=1] 42.odm_y run data get entity @e[tag=42.odm_marker,tag=42.xltt_id,limit=1] Motion[1] 1000
execute if entity @e[tag=42.odm_marker,tag=42.xltt_id,scores={42.odm_y=0..}] run effect give @s slow_falling 1 0 true
scoreboard players set @s[scores={42.odm_time=30..}] 42.odm_time 0
scoreboard players add @s 42.odm_time 1
execute at @s[scores={42.odm_time=1}] run playsound item.elytra.flying player @s ~ ~ ~ .5 2
execute unless entity @e[tag=42.odm_marker,tag=42.xltt_id] run stopsound @s player item.elytra.flying
execute unless entity @e[tag=42.odm_marker,tag=42.xltt_id] run scoreboard players set @s 42.odm_time 0
