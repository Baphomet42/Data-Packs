...
execute at @s[tag=42.tag.xltt.odm.fly,scores={42.obj.xltt.odm_time=1}] run playsound item.elytra.flying player @s ~ ~ ~ .5 2
...
execute if entity @s[tag=42.tag.xltt.odm.fly,tag=!42.tag.xltt.odm.col] run scoreboard players set @s 42.obj.xltt.odm_motion 1
tag @e remove 42.tag.xltt.odm.col
