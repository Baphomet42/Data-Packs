...
execute as @a[tag=42.tag.xltt.id,limit=1] unless items entity @s weapon.mainhand *[custom_data~{42components:{xltt:{odm:{}}}}] unless items entity @s weapon.offhand *[custom_data~{42components:{xltt:{odm:{}}}}] as @e[tag=42.tag.xltt.temp_attempt_break,limit=1] run function 42:xltt/odm/break
