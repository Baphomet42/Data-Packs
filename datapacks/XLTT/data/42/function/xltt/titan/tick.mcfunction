...
execute if entity @s[scores={42.obj.xltt.titan_time=3},predicate=42:xltt/titan_speed_test,nbt={OnGround:1b}] at @s run playsound entity.hoglin.step hostile @a ~ ~ ~ 4 .5
