...
summon vindicator ~ ~ ~ {Tags:["42.tag.summon","42.tag.xltt.titan","42.tag.xltt.titan.group","42.tag.xltt.temp_spawn"],DeathLootTable:"42:empty",PersistenceRequired:true,Invulnerable:true,attributes:[{id:"minecraft:follow_range",base:128d},{id:"minecraft:movement_speed",base:.42d},{id:"minecraft:attack_damage",base:45d}]}
