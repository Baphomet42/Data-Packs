...
summon ravager ~ ~ ~ {Tags:["42.titan","42.titanAI","42.titan_new","42.xltt_temp_spawn"],CustomName:'{"text":"Titan"}',PersistenceRequired:1,DeathLootTable:empty,Invulnerable:1,active_effects:[{id:"invisibility",duration:-1,amplifier:5b,show_particles:0b}],Attributes:[{Name:generic.follow_range,Base:128.0}]}
