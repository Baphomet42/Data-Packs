summon area_effect_cloud ~ ~ ~ {Tags:["42.tag.summon","42.tag.xltt.titan.cloud"],Duration:100,DurationOnUse:0,Particle:{type:cloud},Radius:5,RadiusOnUse:0,RadiusPerTick:-.05,WaitTime:0}
