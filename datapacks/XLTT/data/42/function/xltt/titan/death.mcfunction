...
summon area_effect_cloud ~ ~ ~ {Tags:["42.titanCloud","42.xltt_temp_spawn"],Duration:100,DurationOnUse:0,Particle:{type:cloud},Radius:5,RadiusOnUse:0,RadiusPerTick:-.05,WaitTime:0}
