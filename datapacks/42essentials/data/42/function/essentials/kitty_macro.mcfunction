$execute at @s anchored eyes run summon cat ^ ^-.2 ^.2 {Tags:["42.tag.essentials.kittycannon","42.tag.essentials.need_data"],Silent:1b,Invulnerable:1b,Sitting:1b,Age:-400,Rotation:$(Rotation),DeathLootTable:"42:empty",Team:"42.team.gen.no_col"}
