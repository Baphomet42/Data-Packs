$execute at @s anchored eyes run summon cat ^ ^-.2 ^.2 {Tags:["42.tag.summon","42.tag.essentials.kittycannon","42.tag.essentials.need_data"],Silent:true,Invulnerable:true,Sitting:true,Age:-400,Rotation:$(Rotation),DeathLootTable:"42:empty",PersistenceRequired:true,Team:"42.team.gen.no_col"}
