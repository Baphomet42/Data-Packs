...
# todo zone
#
execute as @e[tag=42.portal_cube_tp] if score @s 42.portal_lvl = 42.portal_loader_lvl 42.portal_temp at @s run function 42:portal/cube/fizzle
execute as @e[tag=42.portal_pellet] if score @s 42.portal_lvl = 42.portal_loader_lvl 42.portal_temp at @s run function 42:portal/pellet/pellet/fizzle
