...
execute as @e[scores={42.portal_link=1..}] at @s unless entity @s[tag=42.portal_wire_lbl] if score @s 42.portal_link = 42.portal 42.portal_link run summon area_effect_cloud ~ ~ ~ {Tags:["42.portal_new_spawn"],Duration:30,DurationOnUse:0,Particle:"flash",Radius:.25d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0}
