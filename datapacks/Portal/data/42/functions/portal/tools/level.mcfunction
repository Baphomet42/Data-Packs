...
execute as @e[scores={42.portal_lvl=1..},type=!player] at @s unless entity @s[tag=42.portal_wire_lbl] if score @s 42.portal_lvl = 42.portal 42.portal_lvl run summon area_effect_cloud ~ ~ ~ {Tags:["42.portal_new_spawn"],Duration:30,DurationOnUse:0,Particle:"flash",Radius:.25d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0}
