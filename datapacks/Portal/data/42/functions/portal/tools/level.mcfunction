...
execute as @e[scores={42.portal_lvl=1..},type=!player] at @s if score @s 42.portal_lvl = 42.portal 42.portal_lvl run scoreboard players add 42.portal 42.portal_temp 1
