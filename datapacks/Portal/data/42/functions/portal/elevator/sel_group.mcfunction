...
execute at @e[tag=42.portal_id,tag=42.portal_elevator,limit=1] run summon area_effect_cloud ~ ~ ~ {Tags:["42.portal_new_spawn"],Duration:10,DurationOnUse:0,Particle:"flash",Radius:.25d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0}
