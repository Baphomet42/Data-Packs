...
execute unless entity @s[tag=42.portal_temp2] if entity @s[tag=42.portal_temp] at @s if score @s 42.portal_x matches 0 if score 42.portal 42.portal_temp matches 0 run function 42:portal/elevator/move/inc_y
