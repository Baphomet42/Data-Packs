...
#
execute if score @s 42.portal_x matches -6..0 run tag @s add 42.portal_temp
...
execute unless entity @s[tag=42.portal_temp] if score 42.portal 42.portal_temp matches 0 run function 42:portal/elevator/move/inc_y
execute if entity @s[tag=42.portal_temp] run function 42:portal/elevator/move/inc_y
#
tag @s remove 42.portal_temp
