...
summon interaction ~ ~1 ~ {width:.4,height:.4,response:1,Tags:["42.portal_pedestal_group","42.portal_pedestal_hit","42.portal_temp"],CustomNameVisible:0b,CustomName:'{"text":"42portal"}'}
execute as @e[tag=42.portal_temp,tag=42.portal_pedestal,limit=1] run function 42:portal/new_id
scoreboard players operation @e[tag=42.portal_temp] 42.portal_id = @e[tag=42.portal_temp,tag=42.portal_pedestal,limit=1] 42.portal_id
