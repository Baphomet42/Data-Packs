...
execute as @e[tag=42.portal_id,tag=42.portal_door_dis] run data merge entity @s {transformation:{translation:[-2.7f,0f,-.3f]},interpolation_duration:10,start_interpolation:-1}
