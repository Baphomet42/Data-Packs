...
execute as @e[tag=42.portal_tp] if entity @s[type=#42:portal_exempt] unless entity @s[type=player,tag=!42.portal_motion,gamemode=!spectator] unless entity @s[tag=42.portal_cube_hit,tag=!42.portal_cube_held,tag=!42.portal_motion_tp] unless entity @s[tag=42.portal_motion_tp] run tag @s remove 42.portal_tp
