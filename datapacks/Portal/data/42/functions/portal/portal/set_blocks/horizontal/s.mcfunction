...
execute if score @s 42.portal_y matches -2 run fill ^ ^1 ^ ^ ^1 ^ smooth_quartz_stairs[facing=north] replace #42:portal_surface
...
execute if score @s 42.portal_y matches 2 run fill ^ ^1 ^ ^ ^1 ^ smooth_quartz_stairs[facing=south,half=top] replace #42:portal_surface