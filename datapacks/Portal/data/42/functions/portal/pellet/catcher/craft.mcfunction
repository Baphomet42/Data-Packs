give @s drowned_spawn_egg[item_name='"High Energy Pellet Catcher"',rarity=uncommon,custom_data={42datapack:3},\
    lore=[\
    ...
    entity_data={id:area_effect_cloud,Duration:10,DurationOnUse:0,Particle:{type:block,block_state:{Name:air}},Radius:.5f,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,\
        Tags:["42.portal_egg","42.portal_spawn_pellet_catcher"]}\
    ]