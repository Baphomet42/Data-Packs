...
summon area_effect_cloud ^ ^ ^-.1666 {Duration:20,DurationOnUse:0,Particle:"dust 1 0 0 1",Radius:.01d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.portal_pellet_catcher_laser_effect","42.portal_new_spawn"]}
