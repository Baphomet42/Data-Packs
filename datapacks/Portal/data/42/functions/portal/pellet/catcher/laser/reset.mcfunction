...
execute as @e[tag=42.portal_pellet_catcher_laser,limit=1,sort=nearest] at @s[tag=!42.portal_pellet_catcher_laser_valid] positioned ^ ^ ^.475 run summon area_effect_cloud ~ ~ ~ {Duration:20,DurationOnUse:0,Particle:"dust 1 0 0 1",Radius:.01d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.portal_pellet_catcher_laser_effect","42.portal_new_spawn"]}
summon area_effect_cloud ^ ^ ^-.1666 {Duration:20,DurationOnUse:0,Particle:"dust 1 0 0 1",Radius:.01d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.portal_pellet_catcher_laser_effect","42.portal_new_spawn"],CustomNameVisible:0b,CustomName:'{"text":"42portal"}'}
