...
execute if entity @s[tag=42.portal_temp2,tag=!42.portal_temp1] as @e[tag=42.portal_new_spawn,tag=42.portal_grill_group] at @s run tp @s ~ ~ ~ ~90 ~
...
execute as @e[tag=42.portal_new_spawn,tag=42.portal_grill,limit=1] at @s align xyz positioned ~.5 ~ ~.5 run summon interaction ^1 ^ ^ {Tags:["42.portal_grill_hit","42.portal_grill_group","42.portal_new_spawn"],width:1,height:3}
execute as @e[tag=42.portal_new_spawn,tag=42.portal_grill,limit=1] run function 42:portal/new_id
scoreboard players operation @e[tag=42.portal_new_spawn] 42.portal_id = @e[tag=42.portal_new_spawn,tag=42.portal_grill,limit=1] 42.portal_id
