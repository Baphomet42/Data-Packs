...
summon block_display ~ ~ ~ {Tags:["42.portal_launch","42.portal_launcher","42.portal_launch_spawn"],CustomNameVisible:0b,CustomName:'{"text":"Aerial Faith Plate"}',block_state:{Name:chiseled_polished_blackstone},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.875f,0f,-1.5f],scale:[1.75f,.1f,3f]},Passengers:[{id:block_display,Tags:["42.portal_launch_dis","42.portal_launcher","42.portal_launch_spawn"],CustomNameVisible:0b,CustomName:'{"text":"42portal"}',block_state:{Name:polished_deepslate},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.5f,0f,-1f],scale:[1f,.125f,2f]}},{id:block_display,Tags:["42.portal_launch_dis","42.portal_launcher","42.portal_launch_spawn"],CustomNameVisible:0b,CustomName:'{"text":"42portal"}',block_state:{Name:black_stained_glass},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.51f,0f,-1.01f],scale:[1.02f,.25f,2.02f]}},{id:block_display,Tags:["42.portal_launcher","42.portal_launch_spawn"],CustomNameVisible:0b,CustomName:'{"text":"42portal"}',block_state:{Name:sea_lantern},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.25f,.15f,-.75f],scale:[.5f,.05f,.5f]}}]}
scoreboard players set @e[type=!player,tag=42.portal_launch_spawn] 42.datapack 3
execute as @e[tag=42.portal_launch_spawn,tag=42.portal_launch,limit=1] run function 42:portal/new_id
scoreboard players operation @e[tag=42.portal_launch_spawn] 42.portal_id = @e[tag=42.portal_launch_spawn,tag=42.portal_launch,limit=1] 42.portal_id
