...
execute as @e[tag=42.portal_launch,limit=1,sort=nearest,distance=..5] at @s run summon armor_stand ~ ~ ~ {Small:1,Invisible:1,Invulnerable:1,DisabledSlots:16191,Tags:["42.portal_motion_tp","42.portal_temp"]}
