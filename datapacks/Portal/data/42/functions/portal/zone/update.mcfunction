...
execute if score @s 42.portal_lvl matches ..0 if score @s 42.portal_x matches 1 as @e[tag=42.portal_id,tag=42.portal_zone_lbl_lvl] run data modify entity @s text set value '{"text":"No level set","color":"red"}'
...
#
execute as @e[tag=42.portal_id,tag=42.portal_zone_lbl_trigger] run data modify entity @s text set value ''
