...
#
execute if entity @s[tag=42.portal_btn] as @e[tag=42.portal_dropper,tag=!42.portal_dropper_on] at @s if score @s 42.portal_link = 42.portal_temp_power 42.portal_temp run function 42:portal/dropper/power
execute if entity @s[tag=42.portal_pellet_catcher] as @e[tag=42.portal_dropper,tag=!42.portal_dropper_on] at @s if score @s 42.portal_link = 42.portal_temp_power 42.portal_temp run function 42:portal/dropper/power
