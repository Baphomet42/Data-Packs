...
execute at @e[tag=42.portal_turret_eye,tag=42.portal_id] positioned ~ ~1 ~ positioned ^ ^ ^.25 facing entity @e[tag=42.portal_turret_laser_find,limit=1,sort=nearest] feet run tp @e[tag=42.portal_turret_laser] ~ ~ ~ ~ ~
