...
execute at @s if block ~ ~ ~ #42:portal_bullet_pass run tp ^ ^ ^.25
execute if score @s 42.portal_time matches 0.. at @s if block ~ ~ ~ #42:portal_bullet_pass unless entity @e[tag=42.portal_turret_current] run function 42:portal/cube/turret/target/laser_move