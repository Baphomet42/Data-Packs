...
#
execute as @e[tag=42.portal_id,tag=42.portal_cube_hit] run data merge entity @s {width:1.01,height:1.5}
execute if entity @e[tag=42.portal_id,tag=42.portal_cube_dis,x_rotation=-90..-30] as @e[tag=42.portal_id,tag=42.portal_cube_hit] run data merge entity @s {width:1.5,height:1}
#
