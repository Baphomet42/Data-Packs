...
execute positioned ~-.5 ~ ~-.5 as @e[tag=42.portal_turret_hit,tag=!42.portal_cube_held,tag=!42.portal_id,dx=0,dy=0,dz=0] at @s run function 42:portal/cube/turret/fall
#
