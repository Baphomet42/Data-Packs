...
execute if entity @s[tag=42.portal_cube_held] if entity @e[tag=42.portal_cube_tp,tag=42.portal_cube_size1,tag=42.portal_id] positioned ~-.5 ~ ~-.5 unless entity @e[tag=42.portal_cube_tp,tag=!42.portal_turret,tag=!42.portal_id,dx=0,dy=0,dz=0] run function 42:portal/cube/hold_test
execute if entity @s[tag=42.portal_cube_held] if entity @e[tag=42.portal_cube_tp,tag=42.portal_cube_size2,tag=42.portal_id] positioned ~-.5 ~ ~-.5 unless entity @e[tag=42.portal_cube_tp,tag=!42.portal_turret,tag=!42.portal_id,dx=0,dy=0,dz=0] run function 42:portal/cube/radio/hold_test
