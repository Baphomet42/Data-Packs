...
execute if entity @s[tag=42.portal_cube_held] if block ~-.5 ~ ~-.5 #42:projectile_pass if block ~-.5 ~ ~.5 #42:projectile_pass if block ~-.5 ~1 ~-.5 #42:projectile_pass if block ~-.5 ~1 ~.5 #42:projectile_pass if block ~.5 ~ ~-.5 #42:projectile_pass if block ~.5 ~ ~.5 #42:projectile_pass if block ~.5 ~1 ~-.5 #42:projectile_pass if block ~.5 ~1 ~.5 #42:projectile_pass positioned ~-.5 ~-.1 ~-.5 unless entity @e[tag=42.portal_cube_tp,tag=!42.portal_id,dx=0,dy=0,dz=0] run tag @s add 42.portal_temp
