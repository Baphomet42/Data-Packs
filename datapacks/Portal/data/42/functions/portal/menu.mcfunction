...
#4203002-4203099
execute if entity @s[tag=!42op,gamemode=!creative,scores={42menu=4203002..4203999}] run function 42:error_perms
scoreboard players set @s[tag=!42op,gamemode=!creative,scores={42menu=4203002..4203999}] 42menu 0
#
