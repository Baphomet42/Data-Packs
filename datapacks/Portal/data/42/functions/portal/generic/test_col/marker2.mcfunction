...
execute unless entity @s[tag=42.portal_test_valid] if block ~ ~ ~ zombie_wall_head[facing=west] if score @s 42.portal_x matches ..80 run tag @s add 42.portal_test_valid
execute unless entity @s[tag=42.portal_test_valid] if block ~ ~ ~ zombie_wall_head[facing=north] if score @s 42.portal_z matches ..80 run tag @s add 42.portal_test_valid
execute unless entity @s[tag=42.portal_test_valid] if block ~ ~ ~ zombie_wall_head[facing=east] if score @s 42.portal_x matches 80.. run tag @s add 42.portal_test_valid
execute unless entity @s[tag=42.portal_test_valid] if block ~ ~ ~ zombie_wall_head[facing=south] if score @s 42.portal_z matches 80.. run tag @s add 42.portal_test_valid