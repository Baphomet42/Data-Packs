...
execute as @e[tag=42.portal_wire] if score @s 42.portal_link = @e[tag=42.portal_wire_this,limit=1] 42.portal_link if entity @s[tag=!42.portal_wire_lbl] run data modify entity @s block_state.Name set value light_blue_concrete
