...
execute unless data storage 42:config settings.portal{resourcepack:1b} unless data storage 42:config settings.portal{resourcepack:0b} run data modify storage 42:config settings.portal.resourcepack set value 1b
