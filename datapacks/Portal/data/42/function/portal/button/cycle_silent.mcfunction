...
execute if entity @s[tag=!42.tag.portal.btn.cube] run data merge entity @e[tag=42.tag.portal.id,tag=42.tag.portal.btn.dis3,limit=1] {block_state:{Name:air}}
execute if entity @s[tag=!42.tag.portal.btn.cube] run data merge entity @e[tag=42.tag.portal.id,tag=42.tag.portal.btn.dis4,limit=1] {block_state:{Name:air}}
execute if entity @s[tag=!42.tag.portal.btn.cube] run data merge entity @e[tag=42.tag.portal.id,tag=42.tag.portal.btn.dis5,limit=1] {block_state:{Name:air}}
