...
summon block_display ~ ~ ~ {Tags:["42.portal_pedestal","42.portal.tags.has_tick","42.portal_pedestal_group","42.portal_temp"],CustomNameVisible:0b,CustomName:'"Pedestal Button"',block_state:{Name:quartz_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.2f,0f,-.2f],scale:[.4f,1f,.4f]},Passengers:[{id:block_display,Tags:["42.portal_pedestal_group","42.portal_temp"],CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:quartz_stairs},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.2f,1f,-.2f],scale:[.4f,.4f,.4f]}},{id:block_display,Tags:["42.portal_pedestal_group","42.portal_pedestal_dis","42.portal_temp"],CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:redstone_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.15f,1.05f,-.15f],scale:[.3f,.3f,.3f]}}]}
summon interaction ~ ~1 ~ {width:.4,height:.4,response:1b,Tags:["42.portal_pedestal_group","42.portal_pedestal_hit","42.portal_temp"]}
