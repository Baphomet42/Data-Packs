...
summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.pedestal","42.tag.portal.tags.has_tick","42.tag.portal.pedestal.group","42.tag.portal.temp"],CustomNameVisible:false,CustomName:"Pedestal Button",block_state:{Name:"minecraft:quartz_block"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.2f,0f,-.2f],scale:[.4f,1f,.4f]},Passengers:[{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.pedestal.group","42.tag.portal.temp"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:quartz_stairs"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.2f,1f,-.2f],scale:[.4f,.4f,.4f]}},{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.pedestal.group","42.tag.portal.pedestal.dis","42.tag.portal.temp"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:redstone_block"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.15f,1.05f,-.15f],scale:[.3f,.3f,.3f]}}]}
summon interaction ~ ~1 ~ {width:.4,height:.4,response:true,Tags:["42.tag.summon","42.tag.portal.pedestal.group","42.tag.portal.pedestal.hit","42.tag.portal.temp"]}
