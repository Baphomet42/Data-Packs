...
execute positioned ~-.875 ~-.625 ~-.875 if entity @e[dx=.75,dy=0,dz=.75,tag=42.tag.portal.cube.tp,tag=42.tag.portal.cube.weighted,limit=1] run tag @s add 42.tag.portal.btn.on
...
execute if entity @s[tag=42.tag.portal.btn.on] positioned ~-.5 ~-.88 ~-.5 as @e[dx=0,dy=0,dz=0,tag=42.tag.portal.cube.tp] at @s run tp @s ~ ~.1875 ~
