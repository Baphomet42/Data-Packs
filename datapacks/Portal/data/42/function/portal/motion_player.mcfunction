...
execute unless entity @e[limit=1,tag=42.tag.portal.portal,distance=..1] run scoreboard players set @s[nbt={OnGround:1b},scores={42.obj.portal.cool=10..}] 42.obj.portal.cool -1
