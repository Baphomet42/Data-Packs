...
execute if score @s 42.obj.portal.cool matches 0.. run effect give @e[limit=1,tag=42.tag.portal.temp_motion_id,tag=!42.tag.portal.motion.tp,sort=nearest] resistance 1 127 true
