...
execute if score @s 42.portal_x matches 1 run fill ~-1 ~ ~ ~1 ~2 ~ polished_blackstone_wall replace #42:portal_replace
execute if score @s 42.portal_x matches 2 run fill ~ ~ ~-1 ~ ~2 ~1 polished_blackstone_wall replace #42:portal_replace
