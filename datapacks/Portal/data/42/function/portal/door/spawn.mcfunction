...
execute if entity @s[tag=42.tag.portal.temp1] run function 42:portal/door/spawn2
execute if entity @s[tag=42.tag.portal.temp2] run function 42:portal/door/spawn2
