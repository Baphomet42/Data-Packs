...
execute as @e[tag=42.tag.portal.dropper] if score @s 42.obj.portal.lvl = #42.var.portal.loader_lvl 42.obj.portal.temp at @s run function 42:portal/dropper/unload
# elevator?
