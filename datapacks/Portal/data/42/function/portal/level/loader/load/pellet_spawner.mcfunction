...
data modify storage 42:portal loader.temp_entity set from storage 42:portal loader.temp_level.equipment.pellet_spawner[-1]

$execute positioned 0.0 0.0 0.0 positioned ~$(pos_x) ~$(pos_y) ~$(pos_z) run function 42:portal/level/loader/test_loaded
$execute positioned 0.0 0.0 0.0 positioned ~$(pos_x) ~$(pos_y) ~$(pos_z) unless data storage 42:portal loader.error run function 42:portal/pellet/spawner/respawn with storage 42:portal loader.temp_entity
...
execute unless data storage 42:portal loader.error run data remove storage 42:portal loader.temp_level.equipment.pellet_spawner[-1]
