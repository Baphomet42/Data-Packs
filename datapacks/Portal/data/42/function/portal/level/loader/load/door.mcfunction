...
data modify storage 42:portal loader.temp_entity set from storage 42:portal loader.temp_level.equipment.door[-1]
...
execute unless data storage 42:portal loader.error run data remove storage 42:portal loader.temp_level.equipment.door[-1]
