...
execute unless entity @a[tag=42.tag.portal.temp] run scoreboard players operation #42.var.portal.temp_lvl_unload 42.obj.portal.temp = @s 42.obj.portal.lvl
execute unless entity @a[tag=42.tag.portal.temp] if score #42.var.portal.temp_lvl_unload 42.obj.portal.temp matches 1.. run function 42:portal/level/loader/try_unload_all
scoreboard players set @s[type=player] 42.obj.portal.lvl 0
tag @e remove 42.tag.portal.temp
