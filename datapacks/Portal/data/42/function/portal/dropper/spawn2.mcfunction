...
summon block_display ~ ~ ~ {Tags:["42.portal_dropper","42.portal_dropper_group","42.portal_spawn_cube1","42.portal_temp","42.portal_is_spawner"],CustomNameVisible:0b,CustomName:'"Vital Apparatus Vent"',block_state:{Name:black_stained_glass},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,-1.5f,-1f],scale:[2f,1.5f,2f]},Passengers:[{id:block_display,Tags:["42.portal_dropper_group","42.portal_skin","42.portal_temp"],CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:black_concrete},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,.875f,-1f],scale:[2f,.12f,2f]}}]}
execute unless entity @s[tag=42.portal_loader] as @e[tag=42.portal_temp,tag=42.portal_dropper,limit=1] run function 42:portal/new_id
execute unless entity @s[tag=42.portal_loader] run scoreboard players operation @e[tag=42.portal_temp] 42.portal_id = @e[tag=42.portal_temp,tag=42.portal_dropper,limit=1] 42.portal_id
...
execute if entity @s[tag=42.portal_loader] run function 42:portal/dropper/load with storage 42:portal loader.temp_entity
tag @e remove 42.portal_temp
