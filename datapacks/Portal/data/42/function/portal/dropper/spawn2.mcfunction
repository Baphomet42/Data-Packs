...
summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.dropper","42.tag.portal.dropper.group","42.tag.portal.tool.spawn.cube.storage","42.tag.portal.temp","42.tag.portal.is_spawner"],CustomNameVisible:false,CustomName:"Vital Apparatus Vent",block_state:{Name:black_stained_glass},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,-1.5f,-1f],scale:[2f,1.5f,2f]},Passengers:[{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.dropper.group","42.tag.portal.skin","42.tag.portal.temp"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:black_concrete},view_range:10f,brightness:{block:0,sky:0},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,.875f,-1f],scale:[2f,.12f,2f]}}]}
