...
execute as @e[tag=42.portal_tp2,limit=1] at @s positioned ^ ^-.5 ^1 run summon armor_stand ~ ~ ~ {Small:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:16191,Tags:["42.portal_motion_tp","42.portal_temp"]}
