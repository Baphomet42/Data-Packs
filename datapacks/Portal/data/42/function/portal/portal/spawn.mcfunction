...
execute unless entity @s[type=marker] run scoreboard players set 42.portal 42.portal_temp -3
execute if entity @s[type=marker] run scoreboard players operation 42.portal 42.portal_temp = @s 42.portal_id
summon block_display ~ ~ ~ {Tags:["42.portal","42.portal.tags.has_tick","42.portal_temp","42.portal_group"],brightness:{block:15,sky:15},CustomNameVisible:0b,CustomName:'"Portal"',block_state:{Name:air},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.8f,-.9f,0f],scale:[1.6f,2.3f,.55f]},Passengers:[\
    {id:block_display,Tags:["42.portal_temp","42.portal_group","42.portal_dis","42.portal_close"],brightness:{block:15,sky:15},CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:air},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.75f,-.85f,0f],scale:[1.5f,2.2f,.525f]}},\
    {id:block_display,Tags:["42.portal_temp","42.portal_group","42.portal_open"],brightness:{block:15,sky:15},CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:coal_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.75f,-.85f,0f],scale:[1.5f,2.2f,.525f]}},\
    {id:block_display,Tags:["42.portal_temp","42.portal_group"],brightness:{block:15,sky:15},CustomNameVisible:0b,CustomName:'"42portal"',block_state:{Name:coal_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.4f,-.9f,-.4f],scale:[2.8f,2.8f,.8f]}}]}
...
execute if entity @s[tag=42.portal_w] as @e[tag=42.portal_temp] at @s run rotate @s 90 ~
execute if entity @s[tag=42.portal_n] run scoreboard players set @e[tag=42.portal_temp,tag=42.portal] 42.portal_x 2
execute if entity @s[tag=42.portal_n] as @e[tag=42.portal_temp] at @s run rotate @s 180 ~
execute if entity @s[tag=42.portal_e] run scoreboard players set @e[tag=42.portal_temp,tag=42.portal] 42.portal_x 3
execute if entity @s[tag=42.portal_e] as @e[tag=42.portal_temp] at @s run rotate @s -90 ~
