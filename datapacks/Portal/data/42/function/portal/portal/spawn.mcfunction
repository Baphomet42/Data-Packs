...
execute unless entity @s[type=marker] run scoreboard players set #42.var.portal.dummy 42.obj.portal.temp -3
execute if entity @s[type=marker] run scoreboard players operation #42.var.portal.dummy 42.obj.portal.temp = @s 42.obj.portal.id
summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.portal","42.tag.portal.tags.has_tick","42.tag.portal.temp","42.tag.portal.portal.group"],brightness:{block:15,sky:15},CustomNameVisible:false,CustomName:"Portal",block_state:"minecraft:air",view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.8f,-.9f,0f],scale:[1.6f,2.3f,.55f]},Passengers:[\
    {id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.temp","42.tag.portal.portal.group","42.tag.portal.portal.dis","42.tag.portal.portal.close"],brightness:{block:15,sky:15},CustomNameVisible:false,CustomName:"42portal",block_state:"minecraft:air",view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.75f,-.85f,0f],scale:[1.5f,2.2f,.525f]}},\
    {id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.temp","42.tag.portal.portal.group","42.tag.portal.portal.open"],brightness:{block:15,sky:15},CustomNameVisible:false,CustomName:"42portal",block_state:"minecraft:coal_block",view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.75f,-.85f,0f],scale:[1.5f,2.2f,.525f]}},\
    {id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.temp","42.tag.portal.portal.group"],brightness:{block:15,sky:15},CustomNameVisible:false,CustomName:"42portal",block_state:"minecraft:coal_block",view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.4f,-.9f,-.4f],scale:[2.8f,2.8f,.8f]}}]}
