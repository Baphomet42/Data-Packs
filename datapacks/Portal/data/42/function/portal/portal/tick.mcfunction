execute if score @s 42.obj.portal.cool matches 1.. run scoreboard players remove @s 42.obj.portal.cool 1
function 42:portal/portal/tag_pair
execute if score @s 42.obj.portal.time matches 20 run function 42:portal/portal/tick20
execute if entity @e[tag=42.tag.portal.portal.a,tag=42.tag.portal.portal.pair] if entity @e[tag=42.tag.portal.portal.b,tag=42.tag.portal.portal.pair] if score @s 42.obj.portal.cool matches 0 run function 42:portal/portal/tp/tick_try_tp
