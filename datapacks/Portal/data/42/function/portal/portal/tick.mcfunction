...
execute if entity @e[tag=42.portal_a,tag=42.portal_pair] if entity @e[tag=42.portal_b,tag=42.portal_pair] if score @s 42.portal_cool matches 0 run function 42:portal/portal/tp/tick_try_tp
