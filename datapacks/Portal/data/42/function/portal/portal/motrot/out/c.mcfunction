...
scoreboard players operation @s 42.obj.portal.motion.y = #42.var.portal.dummy 42.obj.portal.temp
scoreboard players operation @s 42.obj.portal.motion.y *= #42.var.gen.const.neg_1 42.obj.portal.vars
