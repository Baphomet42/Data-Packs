...
execute align xyz positioned ~.5 ~.5 ~.5 run summon block_display ~ ~ ~ \
    {Tags:["42.tag.summon","42.tag.portal.decal.wire","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"Wire",block_state:"minecraft:light_blue_concrete",view_range:10f,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.125f,-.125f,-.5f],scale:[.25f,.25f,.01f]},Passengers:[\
...
scoreboard players set @e[tag=42.tag.portal.new_spawn,tag=!42.tag.portal.decal.wire.lbl] 42.obj.portal.skin 0
...
tag @e remove 42.tag.portal.new_spawn
kill @s[tag=42.tag.portal.decal.wire.unlinked]
tag @s remove 42.tag.portal.decal.wire.unlinked