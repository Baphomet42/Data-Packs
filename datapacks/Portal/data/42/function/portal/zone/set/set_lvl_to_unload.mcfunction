...
execute as @p[tag=42.tag.portal.selected] at @s run tag @e[type=!player,tag=!42.tag.portal.zone,tag=!42.tag.portal.elevator.main,tag=!42.tag.portal.portal,limit=1,sort=nearest,distance=..10,scores={42.obj.portal.lvl=1..}] add 42.tag.portal.temp
scoreboard players operation @s 42.obj.portal.var.a = @e[tag=42.tag.portal.temp,limit=1] 42.obj.portal.lvl
