...
execute as @p[tag=42.tag.portal.selected] at @s run tag @e[type=!player,tag=!42.tag.portal.zone,tag=!42.tag.portal.elevator.main,tag=!42.tag.portal.portal.group,tag=!42.tag.portal.decal.wire,limit=1,sort=nearest,distance=..10,scores={42.obj.portal.link=1..}] add 42.tag.portal.temp
scoreboard players operation @s 42.obj.portal.xrot2 = @e[tag=42.tag.portal.temp,limit=1] 42.obj.portal.link
