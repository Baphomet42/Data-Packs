...
execute if entity @s[tag=42.tag.portal.zone.grill] run execute as @a[tag=42.tag.portal.in_zone,limit=1,sort=nearest,distance=..15] at @s run function 42:portal/portal/clear