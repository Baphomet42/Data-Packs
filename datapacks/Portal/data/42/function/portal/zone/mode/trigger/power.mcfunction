...
execute as @e[tag=42.tag.portal.decal.wire] if score @s 42.obj.portal.link = #42.var.portal.temp_power 42.obj.portal.temp run function 42:portal/decal/wire/power
