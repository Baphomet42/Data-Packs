...
execute as @e[tag=42.portal_cube_spawner] at @s if score @s 42.portal_link = 42.portal_temp_unpower 42.portal_temp run function 42:portal/cube/spawner/unpower
execute as @e[tag=42.portal_pellet_spawner] at @s if score @s 42.portal_link = 42.portal_temp_unpower 42.portal_temp run function 42:portal/pellet/spawner/unpower