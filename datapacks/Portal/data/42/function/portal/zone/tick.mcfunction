...
execute if score @s 42.obj.portal.var.x matches 0 run function 42:portal/zone/mode/load/tick
...
execute if score @s 42.obj.portal.var.x matches 2 if score @s 42.obj.portal.lvl matches 1.. run function 42:portal/zone/mode/death/tick
