...
# flip rotation
execute if entity @s[tag=42.tag.portal.radio] as @e[tag=42.tag.portal.id,tag=42.tag.portal.cube.dis] rotated as @a[tag=42.tag.portal.id,limit=1] run rotate @s ~180 0
execute if entity @s[tag=42.tag.portal.cube.laser] as @e[tag=42.tag.portal.id,tag=42.tag.portal.cube.dis] rotated as @a[tag=42.tag.portal.id,limit=1] run rotate @s ~ 0
