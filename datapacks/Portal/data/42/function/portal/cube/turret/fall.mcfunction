...
execute if entity @s[tag=!42.tag.portal.turret.off,tag=!42.tag.portal.turret.malfunction,tag=!42.tag.portal.cube.held] at @s run function 42:portal/cube/turret/malfunction
