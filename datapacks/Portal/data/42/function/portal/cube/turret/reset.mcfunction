...
execute as @e[tag=42.tag.portal.cube.main,tag=42.tag.portal.id] at @s align xyz positioned ~.5 ~ ~.5 run tp @s ~ ~ ~
...
tag @e[tag=42.tag.portal.cube.main,tag=42.tag.portal.id] remove 42.tag.portal.turret.oracle
tag @e[tag=42.tag.portal.cube.main,tag=42.tag.portal.id] remove 42.tag.portal.turret.nofind
