...
execute at @e[tag=42.tag.portal.turret.eye,tag=42.tag.portal.id] positioned ^ ^1 ^.25 facing entity @e[tag=42.tag.portal.id,tag=42.tag.portal.turret.fire] feet run tp @e[tag=42.tag.portal.turret.laser] ~ ~ ~ ~ ~
scoreboard players set @e[tag=42.tag.portal.turret.laser] 42.obj.portal.time 50
execute as @e[tag=42.tag.portal.turret.laser] at @s run function 42:portal/cube/turret/target/laser_move_dis_bullet
