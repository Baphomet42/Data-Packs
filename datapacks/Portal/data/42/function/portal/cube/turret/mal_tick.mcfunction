...
execute if score @s[tag=!42.portal_turret_oracle] 42.portal_u matches 2 if score @s 42.portal_w matches 41.. run function 42:portal/cube/turret/target/new_laser_mal
execute if score @s[tag=42.portal_turret_oracle] 42.portal_u matches 2 if score @s 42.portal_w matches 1 run function 42:portal/cube/turret/target/new_laser_oracle
