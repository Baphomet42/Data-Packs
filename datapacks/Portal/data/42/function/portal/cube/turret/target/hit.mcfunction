damage @s .00001 generic_kill by @e[tag=42.tag.portal.id,tag=42.tag.portal.cube.main,limit=1]
...
execute if score @s 42.obj.portal.damage matches 100.. run damage @s 500 arrow by @e[tag=42.tag.portal.id,tag=42.tag.portal.cube.main,limit=1]
