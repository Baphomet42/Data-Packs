...
summon area_effect_cloud ~ ~ ~ {Duration:15,DurationOnUse:0,Particle:{type:block,block_state:{Name:air}},Radius:.1d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.tag.summon","42.tag.portal.turret.fire","42.tag.portal.new_spawn"]}
