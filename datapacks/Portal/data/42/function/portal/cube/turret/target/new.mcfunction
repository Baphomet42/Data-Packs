...
summon area_effect_cloud ~ ~ ~ {Duration:15,DurationOnUse:0,custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Radius:.1d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.tag.summon","42.tag.portal.turret.fire","42.tag.portal.new_spawn"]}
