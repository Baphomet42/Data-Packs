...
execute at @s as @e[limit=1,sort=nearest,tag=42.tag.portal.turret.target.tempvalid] unless entity @s[tag=42.tag.portal.turret.laser] run tag @e[tag=42.tag.portal.turret.target_current,limit=1] add 42.tag.portal.turret.current
