execute if entity @e[tag=42.portal_cube_hit,tag=42.portal_id,tag=42.portal_cube_held] as @e[tag=42.portal_id,tag=42.portal_cube_dis] at @s rotated as @p[tag=42.portal_id] run rotate @s ~ ~
execute if entity @e[tag=42.portal_cube_hit,tag=42.portal_id,tag=42.portal_cube_held] as @e[tag=42.portal_id,tag=42.portal_cube_dis,x_rotation=0.1..90] at @s run rotate @s ~ 0
execute if entity @e[tag=42.portal_cube_hit,tag=42.portal_id,tag=!42.portal_cube_held] as @e[tag=42.portal_id,tag=42.portal_cube_dis,x_rotation=-30..-0.1] at @s run rotate @s ~ 0
