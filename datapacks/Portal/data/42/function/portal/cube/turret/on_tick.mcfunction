...
execute if entity @s[tag=42.tag.portal.cube.held] if score @s 42.obj.portal.var.v matches ..80 run scoreboard players set @s 42.obj.portal.var.v 80
execute if entity @s[tag=42.tag.portal.cube.held] if entity @s[tag=!42.tag.portal.turret.open] run function 42:portal/cube/turret/arms/open

execute if entity @s[tag=42.tag.portal.cube.gel.blue,tag=!42.tag.portal.cube.held] run function 42:portal/cube/turret/fall