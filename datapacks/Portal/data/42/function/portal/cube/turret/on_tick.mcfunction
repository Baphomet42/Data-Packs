...
execute if score @s[tag=42.portal_turret_always_on] 42.portal_u matches 2 unless entity @e[tag=42.portal_id,tag=42.portal_turret_fire] run function 42:portal/cube/turret/target/new_laser_mal
