...
tag @a[distance=..35,gamemode=!spectator] add 42.portal_turret_target
tag @e[distance=..35,type=villager] add 42.portal_turret_target
...
execute if entity @e[tag=42.portal_turret_current] at @s run function 42:portal/cube/turret/target/new_laser_bullet
tag @e remove 42.portal_turret_current
tag @e remove 42.portal_turret_this