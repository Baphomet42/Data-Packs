...
scoreboard players set @e[tag=42.tag.portal.turret.laser] 42.obj.portal.time 25
execute as @e[tag=42.tag.portal.turret.laser] at @s run function 42:portal/cube/turret/target/laser_move_dis_mal
