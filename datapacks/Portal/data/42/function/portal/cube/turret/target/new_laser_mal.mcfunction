...
scoreboard players set @e[tag=42.portal_turret_laser] 42.portal_time 25
execute as @e[tag=42.portal_turret_laser] at @s run function 42:portal/cube/turret/target/laser_move_dis_mal
