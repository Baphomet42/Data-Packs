...
execute at @e[tag=42.portal_btn,distance=..3] positioned ~-.875 ~-.625 ~-.875 run tag @s[dx=0,dy=0,dz=0] add 42.portal_temp
execute at @e[tag=42.portal_btn,distance=..3] positioned ~-.875 ~-.625 ~-.125 run tag @s[dx=0,dy=0,dz=0] add 42.portal_temp
execute at @e[tag=42.portal_btn,distance=..3] positioned ~-.125 ~-.625 ~-.875 run tag @s[dx=0,dy=0,dz=0] add 42.portal_temp
execute at @e[tag=42.portal_btn,distance=..3] positioned ~-.125 ~-.625 ~-.125 run tag @s[dx=0,dy=0,dz=0] add 42.portal_temp
