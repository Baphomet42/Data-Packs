...
scoreboard players operation @e[tag=!42.tag.portal.vent,tag=42.tag.portal.vent.drop,tag=42.tag.portal.cube.main,distance=..10] 42.obj.portal.lvl = @s 42.obj.portal.lvl
tag @e remove 42.tag.portal.vent.drop