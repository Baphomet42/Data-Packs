function 42:portal/vent/cycle_silent
...
execute if score @s 42.obj.portal.var.x matches 5 positioned ~ ~-3.5 ~ run data merge entity @e[tag=42.tag.portal.notif,limit=1,sort=nearest] {CustomName:"Vent Drop Type: Repulsion Gel"}
execute if score @s 42.obj.portal.var.x matches 6 positioned ~ ~-3.5 ~ run data merge entity @e[tag=42.tag.portal.notif,limit=1,sort=nearest] {CustomName:"Vent Drop Type: Propulsion Gel"}
execute if score @s 42.obj.portal.var.x matches 7 positioned ~ ~-3.5 ~ run data merge entity @e[tag=42.tag.portal.notif,limit=1,sort=nearest] {CustomName:"Vent Drop Type: Conversion Gel"}
execute if score @s 42.obj.portal.var.x matches 8 positioned ~ ~-3.5 ~ run data merge entity @e[tag=42.tag.portal.notif,limit=1,sort=nearest] {CustomName:"Vent Drop Type: Cleansing Gel"}