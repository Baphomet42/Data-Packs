...
summon text_display ~ ~ ~ {Tags:["42.tag.portal.grill","42.tag.portal.grill.group","42.tag.portal.new_spawn"],CustomNameVisible:0b,CustomName:'"Emancipation Grill"',text:'{"text":"iiiiiiii","color":"aqua","obfuscated":true}',alignment:center,background:0,text_opacity:127,view_range:10f,brightness:{sky:15,block:15},transformation:{left_rotation:[0f,0f,.7071f,.7071f],right_rotation:[0f,0f,0f,1f],translation:[1.75f,1.375f,0f],scale:[7.5f,14f,.25f]},Passengers:[\
    {id:text_display,Tags:["42.tag.portal.grill.group","42.tag.portal.new_spawn"],CustomNameVisible:0b,CustomName:'"42portal"',text:'{"text":"iiiiiiii","color":"aqua","obfuscated":true}',alignment:center,background:0,text_opacity:127,view_range:10f,brightness:{sky:15,block:15},Rotation:[180f,0f],transformation:{left_rotation:[0f,0f,.7071f,.7071f],right_rotation:[0f,0f,0f,1f],translation:[1.75f,1.375f,0f],scale:[7.5f,14f,.25f]}},\
