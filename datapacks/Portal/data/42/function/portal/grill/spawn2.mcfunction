...
summon text_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.grill","42.tag.portal.grill.group","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"Emancipation Grill",text:{text:"iiiiiiii",color:"aqua",obfuscated:true},alignment:center,background:0,text_opacity:127,view_range:10f,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,.7071f,.7071f],right_rotation:[0f,0f,0f,1f],translation:[1.75f,1.375f,0f],scale:[7.5f,14f,.25f]},Passengers:[\
    ...
    {id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.grill.group","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:iron_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1.5f,0f,-.25f],scale:[.25f,3f,.5f]}},\
    {id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.grill.group","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:iron_block},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[1.25f,0f,-.25f],scale:[.25f,3f,.5f]}}]}
