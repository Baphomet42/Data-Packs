execute if entity @s[tag=42.portal_motion_tp_player] run function 42:portal/motion_player
execute if entity @s[tag=!42.portal_motion_tp_player] run function 42:portal/motion_entity
