...
scoreboard players operation @s 42.obj.portal.pmotion.x = @e[tag=42.tag.portal.faith_plate,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.x
scoreboard players operation @s 42.obj.portal.pmotion.y = @e[tag=42.tag.portal.faith_plate,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.y
scoreboard players operation @s 42.obj.portal.pmotion.z = @e[tag=42.tag.portal.faith_plate,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.z
