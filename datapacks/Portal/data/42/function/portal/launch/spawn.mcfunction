...
summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.launch","42.tag.portal.tags.has_tick","42.tag.portal.launch.group","42.tag.portal.launch.spawn"],CustomNameVisible:false,CustomName:"Aerial Faith Plate",block_state:{Name:"minecraft:chiseled_polished_blackstone"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.875f,0f,-1.5f],scale:[1.75f,.1f,3f]},Passengers:[{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.launch.dis","42.tag.portal.launch.group","42.tag.portal.launch.spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:polished_deepslate"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.5f,.025f,-1f],scale:[1f,.1f,2f]}},{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.launch.dis","42.tag.portal.launch.group","42.tag.portal.launch.spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:black_stained_glass"},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.51f,.025f,-1.01f],scale:[1.02f,.225f,2.02f]}},{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.launch.group","42.tag.portal.launch.spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:sea_lantern"},view_range:10f,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.25f,.15f,-.75f],scale:[.5f,.05f,.5f]}}]}
