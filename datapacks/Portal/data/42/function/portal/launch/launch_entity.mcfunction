...
scoreboard players operation @s 42.obj.portal.motion.x = @e[tag=42.tag.portal.launch,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.x
scoreboard players operation @s 42.obj.portal.motion.y = @e[tag=42.tag.portal.launch,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.y
scoreboard players operation @s 42.obj.portal.motion.z = @e[tag=42.tag.portal.launch,limit=1,sort=nearest,distance=..5] 42.obj.portal.var.z
