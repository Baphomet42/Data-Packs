tellraw @p[tag=42.tag.portal.selected] [{text:"",color:"gray"},\
    ...
    {text:"\n      "},"[",{text:"South/North...",color:"#DDDDDD",click_event:{action:"suggest_command",command:"/function 42:portal/launch/set_velocity_z {z:1000}"}},"]",\
    {text:"\n      "},"[",{text:"East/West...",color:"#DDDDDD",click_event:{action:"suggest_command",command:"/function 42:portal/launch/set_velocity_x {x:1000}"}},"]",\
    {text:"\n      "},"[",{text:"Up/Down...",color:"#DDDDDD",click_event:{action:"suggest_command",command:"/function 42:portal/launch/set_velocity_y {y:1000}"}},"]",\
