...
$scoreboard players set @e[tag=42.tag.portal.selected,tag=42.tag.portal.launch] 42.obj.portal.var.y $(y)
$scoreboard players set @e[tag=42.tag.portal.selected,tag=42.tag.portal.launch] 42.obj.portal.var.z $(z)
