...
execute as @e[tag=42.tag.portal.test.z] at @s run function 42:portal/generic/find_all/z
...
execute if score @s 42.obj.portal.var.u matches 0.. at @s run function 42:portal/generic/find_all/x