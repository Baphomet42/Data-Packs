...
execute as @e[tag=42.portal_test_z] at @s run function 42:portal/generic/test_range/z
...
execute if score @s 42.portal_u matches 0.. at @s run function 42:portal/generic/test_range/x