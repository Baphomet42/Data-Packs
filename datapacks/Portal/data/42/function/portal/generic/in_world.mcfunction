#   before calling this function: /scoreboard players set #42.var.portal.dummy 42.obj.portal.temp 0
#   call this function at any position to test if it's in the world height
#   if the block is in the world height, it adds 1 to #42.var.portal.dummy 42.obj.portal.temp
...
execute unless entity @s[tag=42.tag.portal.temp3] align xyz positioned ~.5 ~.5 ~.5 run particle block_marker{block_state:"minecraft:barrier"} ~ ~ ~ 0 0 0 0 1 force
tag @s remove 42.tag.portal.temp3