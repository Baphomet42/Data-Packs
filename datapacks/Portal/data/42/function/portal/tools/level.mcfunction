...
scoreboard players operation @e[scores={42.obj.portal.lvl=-1},type=!player,tag=!42.tag.portal.portal] 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.lvl

execute if entity @s[tag=42.tag.portal.temp3] run scoreboard players operation @e[tag=42.tag.portal.zone.mode.trigger,scores={42.obj.portal.lvl=-2}] 42.obj.portal.var.b = #42.var.portal.dummy 42.obj.portal.lvl
execute if entity @s[tag=42.tag.portal.temp3] run scoreboard players operation @e[tag=42.tag.portal.zone.mode.trigger,scores={42.obj.portal.lvl=-2}] 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.lvl
execute if entity @s[tag=42.tag.portal.temp3] as @e[tag=42.tag.portal.zone.mode.trigger] if score @s 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.lvl at @s run function 42:portal/zone/update

scoreboard players set #42.var.portal.dummy 42.obj.portal.temp 0
execute as @e[scores={42.obj.portal.lvl=1..},type=!player] at @s unless entity @s[tag=42.tag.portal.decal.wire.lbl] if score @s 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.lvl run summon area_effect_cloud ~ ~ ~ {Tags:["42.tag.summon"],Duration:30,DurationOnUse:0,custom_particle:{type:"minecraft:flash",color:[1,1,1,1]},Radius:.25d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0}
execute as @e[scores={42.obj.portal.lvl=1..},type=!player] at @s unless entity @s[tag=42.tag.portal.decal.wire.lbl] if score @s 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.lvl run scoreboard players add #42.var.portal.dummy 42.obj.portal.temp 1
