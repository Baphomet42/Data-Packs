summon marker ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.laser.beam","42.tag.portal.tags.has_tick","42.tag.portal.laser.beam.new"],CustomNameVisible:false,CustomName:"42portal"}
