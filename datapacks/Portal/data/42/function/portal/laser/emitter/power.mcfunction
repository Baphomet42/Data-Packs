...
execute as @e[tag=42.tag.portal.id,tag=42.tag.portal.laser.emitter.glass] run data modify entity @s block_state.Name set value "minecraft:red_stained_glass"
