...
execute if entity @s[tag=!42.portal_pellet_on] if entity @s[x_rotation=0] run rotate @s ~180 ~
...
execute if entity @s[tag=!42.portal_pellet_on] if score @s 42.portal_z matches 1 run rotate @s ~ 90
execute if entity @s[tag=!42.portal_pellet_on] if score @s 42.portal_z matches 2 run rotate @s ~ -90
