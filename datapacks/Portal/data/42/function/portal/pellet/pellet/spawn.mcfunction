...
execute if entity @s[tag=42.tag.portal.tool.spawn.pellet.super] run data merge entity @e[tag=42.tag.portal.pellet.spawn,limit=1] {item:{id:ender_pearl},CustomName:'"High Energy Super Pellet"'}
