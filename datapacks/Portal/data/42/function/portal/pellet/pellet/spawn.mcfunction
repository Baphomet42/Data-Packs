...
summon item_display ~ ~.5 ~ {Tags:["42.portal_pellet","42.portal.tags.has_tick","42.portal_pellet_spawn"],CustomNameVisible:0b,CustomName:'"High Energy Pellet"',item:{id:ender_eye},item_display:fixed,billboard:center,brightness:{sky:15,block:15},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]}}
...
execute as @e[tag=42.portal_pellet_spawn] at @s run rotate @s 0 -90
...
execute if entity @s[tag=42.portal_spawn_super_pellet] run data merge entity @e[tag=42.portal_pellet_spawn,limit=1] {item:{id:ender_pearl},CustomName:'"High Energy Super Pellet"'}
