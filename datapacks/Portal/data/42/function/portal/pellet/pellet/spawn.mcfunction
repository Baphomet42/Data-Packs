...
summon item_display ~ ~.5 ~ {Tags:["42.tag.summon","42.tag.portal.pellet","42.tag.portal.tags.has_tick","42.tag.portal.pellet.spawn"],CustomNameVisible:false,CustomName:"High Energy Pellet",item:{id:"minecraft:ender_eye"},item_display:"fixed",billboard:"center",view_range:10f,teleport_duration:1,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]}}
