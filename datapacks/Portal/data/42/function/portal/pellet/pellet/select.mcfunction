tellraw @p[tag=42.tag.portal.selected] [{text:"",color:"gray"},\
    ...
    {text:"\n      "},"[",{text:"Fizzle",color:"#DDDDDD",click_event:{action:"run_command",command:"/trigger 42menu set 4203569"}},"]"\
    ]
execute if entity @s[tag=42.tag.portal.pellet.super] run tellraw @p[tag=42.tag.portal.selected] [{text:"",color:"gray"},\
    {text:"      "},"[",{text:"Convert to Spawner",color:"#DDDDDD",click_event:{action:"run_command",command:"/trigger 42menu set 4203568"}},"]",\
