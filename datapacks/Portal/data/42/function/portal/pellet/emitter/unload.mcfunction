...
execute if entity @s[tag=42.tag.portal.tool.spawn.pellet.super] run data modify storage 42:portal loader.temp_entity.tag_spawn_super_pellet set value 1b
