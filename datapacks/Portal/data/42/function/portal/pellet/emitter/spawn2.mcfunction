...
execute as @e[tag=42.portal_new_spawn,tag=42.portal_pellet_emitter_group] at @s run rotate @s 0 -90
...
execute if entity @s[tag=42.portal_loader] run function 42:portal/pellet/emitter/load with storage 42:portal loader.temp_entity
