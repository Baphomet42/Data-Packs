...
execute if entity @s[tag=42.tag.portal.emitter.on] unless entity @e[tag=42.tag.portal.pellet.on,tag=42.tag.portal.id] run data merge entity @e[tag=42.tag.portal.pellet.emitter.glass,tag=42.tag.portal.id,limit=1,sort=nearest] {block_state:{Name:"minecraft:blue_stained_glass"}}
execute if entity @s[tag=42.tag.portal.emitter.on] if entity @e[tag=42.tag.portal.pellet.on,tag=42.tag.portal.id] run data merge entity @e[tag=42.tag.portal.pellet.emitter.glass,tag=42.tag.portal.id,limit=1,sort=nearest] {block_state:{Name:"minecraft:orange_stained_glass"}}
