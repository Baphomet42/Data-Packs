...
execute if data storage 42:portal loader.temp_entity.tag_spawn_super_pellet run execute as @e[tag=42.tag.portal.new_spawn,tag=42.tag.portal.pellet.emitter] at @s run function 42:portal/pellet/emitter/cycle_silent