...
summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.new_spawn","42.tag.portal.pellet.spawner","42.tag.portal.pellet.spawner.group","42.tag.portal.tool.spawn.pellet.super","42.tag.portal.is_spawner"],CustomNameVisible:false,CustomName:"Super Pellet Spawner",block_state:{Name:"minecraft:ice"},view_range:0f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.25f,-.25f,-.25f],scale:[.5f,.5f,.5f]},Passengers:[\
