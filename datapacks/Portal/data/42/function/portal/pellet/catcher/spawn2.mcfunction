...
summon block_display ~ ~.5 ~ {Tags:["42.tag.summon","42.tag.portal.pellet.catcher","42.tag.portal.tags.has_tick","42.tag.portal.pellet.catcher.group","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"High Energy Pellet Catcher",block_state:{Name:"minecraft:quartz_pillar",Properties:{axis:"z"}},view_range:10f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-1f,-1f,-.5f],scale:[2f,2f,.333f]},Passengers:[{id:"minecraft:block_display",Tags:["42.tag.summon","42.tag.portal.pellet.catcher.group","42.tag.portal.pellet.catcher.glass","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"42portal",block_state:{Name:"minecraft:blue_stained_glass"},view_range:10f,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.375f,-.375f,-.45f],scale:[.75f,.75f,.75f]}}]}
