...
summon area_effect_cloud ^ ^ ^-.1666 {Duration:20,DurationOnUse:0,Particle:{type:dust,color:[1.0,0.0,0.0],scale:1},Radius:.01d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0,Tags:["42.tag.summon","42.tag.portal.pellet.catcher.laser_effect"],CustomNameVisible:0b,CustomName:'"42portal"'}
