...
execute if data storage 42:portal loader.temp_entity.tag_nolaser run execute as @e[tag=42.tag.portal.new_spawn,tag=42.tag.portal.pellet.catcher] at @s run function 42:portal/pellet/catcher/cycle_silent