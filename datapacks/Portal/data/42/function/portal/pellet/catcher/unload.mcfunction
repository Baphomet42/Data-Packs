...
execute if entity @s[tag=42.tag.portal.pellet.catcher.nolaser] run data modify storage 42:portal loader.temp_entity.tag_nolaser set value true
function 42:portal/pellet/catcher/fizzle

scoreboard players add #42.var.portal.loader.equipment_count 42.obj.portal.temp 1
data modify storage 42:portal loader.temp_level.equipment.pellet_catcher append from storage 42:portal loader.temp_entity