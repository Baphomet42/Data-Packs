...
execute if entity @s[tag=42.tag.portal.elevator.main,tag=42.tag.portal.elevator.show,tag=42.tag.portal.elevator.on] run return run function 42:portal/elevator/on_tick
