...
execute if data storage 42:portal current_unload_lvl store result score #42.var.portal.dummy2 42.obj.portal.vars run data get storage 42:portal current_unload_lvl
...
execute if data storage 42:portal current_load_lvl store result score #42.var.portal.dummy3 42.obj.portal.vars run data get storage 42:portal current_load_lvl
