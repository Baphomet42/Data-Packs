...
execute as @a[scores={42.obj.portal.lvl=1..}] if score @s 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.var.a unless score @s 42.obj.portal.lvl = #42.var.portal.dummy2 42.obj.portal.vars run scoreboard players set #42.var.portal.dummy 42.obj.portal.vars 1
execute as @a[scores={42.obj.portal.lvl=1..}] if score @s 42.obj.portal.lvl = #42.var.portal.dummy 42.obj.portal.var.b unless score @s 42.obj.portal.lvl = #42.var.portal.dummy2 42.obj.portal.vars run scoreboard players set #42.var.portal.dummy 42.obj.portal.vars 1
