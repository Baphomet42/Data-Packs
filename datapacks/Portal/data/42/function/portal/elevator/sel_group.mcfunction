...
execute at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator,limit=1] run summon area_effect_cloud ~ ~ ~ {Tags:["42.tag.summon"],Duration:10,DurationOnUse:0,custom_particle:{type:"minecraft:flash"},Radius:.25d,RadiusOnUse:0,RadiusPerTick:0,WaitTime:0}
