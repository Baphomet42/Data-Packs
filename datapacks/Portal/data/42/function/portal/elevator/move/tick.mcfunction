...
execute store result score #42.var.portal.dummy 42.obj.portal.temp run data get entity @s Motion[1] 100
#TODO optimize with movement predicate
execute if score #42.var.portal.dummy 42.obj.portal.temp matches -10..10 if score @s 42.obj.portal.cool matches 60.. run function 42:portal/elevator/move/blocked

execute if score @s 42.obj.portal.var.x matches 1.. run effect give @e[tag=42.tag.portal.temp] levitation 1 2 true
execute if score @s 42.obj.portal.var.x matches ..-1 run effect give @e[tag=42.tag.portal.temp,type=player] levitation 1 252 true
execute if score @s 42.obj.portal.var.x matches ..-1 run data modify entity @s Motion[1] set value -.137
