...
execute at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.end] run fill ~-1 ~ ~-1 ~1 ~ ~1 smooth_quartz_slab replace #42:portal/portal_replace
execute at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.end] run tp @s ~ ~.5 ~
