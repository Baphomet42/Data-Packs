...
execute if entity @s[tag=42.tag.portal.temp] at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.end,limit=1] if score @s 42.obj.portal.var.x matches 0 positioned ~-1 ~-1 ~-1 run function 42:portal/generic/test_range {dx:2,dy:0,dz:2,mode:"unless",block:"'#42:portal/portal_replace'"}
execute if entity @s[tag=42.tag.portal.temp] at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.end,limit=1] if score @s 42.obj.portal.var.x matches 0 if score #42.var.portal.dummy 42.obj.portal.temp matches 1 positioned ~-1 ~-1 ~-1 run function 42:portal/generic/find_all {dx:2,dy:0,dz:2,mode:"unless",block:"'#42:portal/portal_replace'"}
execute unless entity @s[tag=42.tag.portal.temp3] if entity @s[tag=42.tag.portal.temp] at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.end,limit=1] if score @s 42.obj.portal.var.x matches 0 if score #42.var.portal.dummy 42.obj.portal.temp matches 0 run function 42:portal/elevator/move/dec_y
