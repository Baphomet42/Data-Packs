...
execute at @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.car,limit=1] positioned ~-1.5 ~ ~-1.5 run tag @a[dx=2,dy=2,dz=2,gamemode=!spectator] add 42.tag.portal.temp.in_elevator
