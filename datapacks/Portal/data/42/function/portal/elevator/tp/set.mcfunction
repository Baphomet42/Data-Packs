...
execute store result score @s 42.obj.portal.var.u run data get entity @e[tag=42.tag.portal.elevator.pair,limit=1] Pos[0]
execute store result score @s 42.obj.portal.var.v run data get entity @e[tag=42.tag.portal.elevator.pair,limit=1] Pos[1]
execute store result score @s 42.obj.portal.var.w run data get entity @e[tag=42.tag.portal.elevator.pair,limit=1] Pos[2]
