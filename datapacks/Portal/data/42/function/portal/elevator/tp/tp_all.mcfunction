...
execute as @e[tag=42.tag.portal.elevator.main,tag=!42.tag.portal.id] if score @s 42.obj.portal.id = @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.main,limit=1] 42.obj.portal.xrot2 run tag @s add 42.tag.portal.elevator.this.to
...
data modify storage 42:portal tp_temp.from_pos set from entity @e[tag=42.tag.portal.id,tag=42.tag.portal.elevator.car,limit=1] Pos
