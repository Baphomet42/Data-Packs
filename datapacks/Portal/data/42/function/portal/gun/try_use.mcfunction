...
execute if items entity @s weapon.mainhand *[custom_data~{portal_gun:{pair_type:0b}}] run tag @s add 42.portal_gun_arg_a
execute if items entity @s weapon.mainhand *[custom_data~{portal_gun:{pair_type:1b}}] run tag @s add 42.portal_gun_arg_b
#
scoreboard players set 42.portal_temp 42.portal_skin 0
execute store result score 42.portal_temp 42.portal_skin run data get entity @s SelectedItem.components.minecraft:custom_data.portal_gun.color
scoreboard players set 42.portal_temp 42.portal_link 0
execute store result score 42.portal_temp 42.portal_link run data get entity @s SelectedItem.components.minecraft:custom_data.portal_gun.pair_link
