...
execute anchored eyes positioned ^-.4 ^-.5 ^.8 run summon block_display ~ ~ ~ \
    ...
    {id:block_display,Tags:["42.portal_new_spawn","42.portal_gun_display_group"],block_state:{Name:black_concrete},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[.125f,.125f,.0625f],translation:[-.0625f,-.0625f,.225f]},interpolation_duration:0,teleport_duration:1},\
    {id:block_display,Tags:["42.portal_new_spawn","42.portal_gun_display_group"],block_state:{Name:gray_stained_glass},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[.05f,.02f,.05f],translation:[-.025f,.125f,-.35f]},interpolation_duration:0,teleport_duration:1},\
    {id:block_display,Tags:["42.portal_new_spawn","42.portal_gun_display_group"],block_state:{Name:black_concrete},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[.04f,.0075f,.04f],translation:[-.02f,.125f,-.345f]},interpolation_duration:0,teleport_duration:1}\
    ]}
...
execute anchored eyes positioned ^-.4 ^-.5 ^.8 run tp @e[tag=42.portal_new_spawn,tag=42.portal_gun_display_group_vehicle] ~ ~ ~
execute as @e[tag=42.portal_new_spawn] run rotate @s ~ ~
tag @e remove 42.portal_new_spawn