...
execute on target at @s anchored eyes positioned ^-.4 ^-.5 ^.8 run tp @e[tag=42.portal_id,tag=42.portal_gun_display_group_vehicle] ~ ~ ~
execute on target at @s as @e[tag=42.portal_id] run rotate @s ~ ~
