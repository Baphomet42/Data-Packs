...
execute on target if items entity @s weapon.mainhand *[custom_data~{42components:{portal:{portal_gun:{}}}}] run tag @e[tag=42.tag.portal.temp] remove 42.tag.portal.temp
