...
summon item ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.new_spawn"],Item:{id:warped_fungus_on_a_stick,components:{\
    "minecraft:custom_data":{42data:{datapack_item:{},portal:{portal_gun:{pair_type:0b,pair_link:1,color:0}}}},\
...
execute as @e[tag=42.tag.portal.new_spawn] if items entity @s contents *[custom_data~{42data:{portal:{portal_gun:{pair_type:0}}}}] run data modify entity @s Item.components.minecraft:custom_data.42data.portal.portal_gun.pair_type set value 0b
execute as @e[tag=42.tag.portal.new_spawn] if items entity @s contents *[custom_data~{42data:{portal:{portal_gun:{pair_type:1}}}}] run data modify entity @s Item.components.minecraft:custom_data.42data.portal.portal_gun.pair_type set value 1b
execute as @e[tag=42.tag.portal.new_spawn] if items entity @s contents *[custom_data~{42data:{portal:{portal_gun:{pair_type:1b}}}}] run data modify entity @s Item.id set value "carrot_on_a_stick"
