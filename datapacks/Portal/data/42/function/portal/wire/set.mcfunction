...
execute align xyz positioned ~.5 ~.5 ~.5 run summon block_display ~ ~ ~ \
    ...
    {id:"minecraft:text_display",Tags:["42.tag.summon","42.tag.portal.wire","42.tag.portal.new_spawn","42.tag.portal.wire.lbl"],CustomNameVisible:false,CustomName:"42portal",text:{text:"\u274C",color:"black"},alignment:"center",background:0,view_range:0f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.05f,-.515f,-.485f],scale:[3.75f,3.75f,3.75f]}}]}
