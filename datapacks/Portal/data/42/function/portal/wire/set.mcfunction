...
execute align xyz positioned ~.5 ~.5 ~.5 run summon block_display ~ ~ ~ {Tags:["42.tag.summon","42.tag.portal.wire","42.tag.portal.new_spawn"],CustomNameVisible:false,CustomName:"Wire",block_state:{Name:"minecraft:light_blue_concrete"},view_range:10f,brightness:{block:15,sky:15},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.125f,-.125f,-.6875f],scale:[.25f,.25f,.25f]},Passengers:[{id:"minecraft:text_display",Tags:["42.tag.summon","42.tag.portal.wire","42.tag.portal.new_spawn","42.tag.portal.wire.lbl"],CustomNameVisible:false,CustomName:"42portal",text:{text:"\u274C",color:"black"},alignment:"center",background:0,view_range:0f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.05f,-.515f,-.4375f],scale:[3.75f,3.75f,3.75f]}}]}
