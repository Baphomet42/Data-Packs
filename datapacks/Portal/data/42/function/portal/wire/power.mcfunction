...
execute as @e[tag=42.tag.portal.wire] if score @s 42.obj.portal.link = @e[tag=42.tag.portal.wire.this,limit=1] 42.obj.portal.link if entity @s[tag=!42.tag.portal.wire.lbl] run data modify entity @s block_state.Name set value orange_concrete
