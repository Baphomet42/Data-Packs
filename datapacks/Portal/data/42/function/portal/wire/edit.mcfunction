...
execute if score @s[tag=!42.portal_wire_lbl] 42.portal_z matches 0 align xyz positioned ~.5 ~.5 ~.5 run summon glow_item_frame ~ ~ ~ {Fixed:1,Item:{id:redstone_block,components:{item_name:'"Unlinked Wire"',rarity:uncommon,custom_data:{42datapack:3}}},ItemDropChance:0f,Tags:["42.portal_new_spawn","42.portal_wire_unlinked"],Facing:3b}
execute if score @s[tag=!42.portal_wire_lbl] 42.portal_z matches 1 align xyz positioned ~.5 ~.5 ~.5 run summon glow_item_frame ~ ~ ~ {Fixed:1,Item:{id:redstone_block,components:{item_name:'"Unlinked Wire"',rarity:uncommon,custom_data:{42datapack:3}}},ItemDropChance:0f,Tags:["42.portal_new_spawn","42.portal_wire_unlinked"],Facing:4b}
execute if score @s[tag=!42.portal_wire_lbl] 42.portal_z matches 2 align xyz positioned ~.5 ~.5 ~.5 run summon glow_item_frame ~ ~ ~ {Fixed:1,Item:{id:redstone_block,components:{item_name:'"Unlinked Wire"',rarity:uncommon,custom_data:{42datapack:3}}},ItemDropChance:0f,Tags:["42.portal_new_spawn","42.portal_wire_unlinked"],Facing:5b}
