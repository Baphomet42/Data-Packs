...
execute store result storage 42:src temp_gun.components.minecraft:custom_data.42components.src.gun.cooldown.time_equipped int 1 run time query gametime
