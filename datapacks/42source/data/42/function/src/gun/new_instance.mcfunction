...
execute store result storage 42:src temp_gun.components.minecraft:custom_data.42data.src.gun.equip_instance int 1 run scoreboard players get @s 42.obj.src.gun.equip_instance
...
execute if data storage 42:src temp_gun.components.minecraft:custom_data.42data.src.gun.cooldown.cool_until store result score #42.var.src.temp.t2 42.obj.src.temp run data get storage 42:src temp_gun.components.minecraft:custom_data.42data.src.gun.cooldown.cool_until
scoreboard players operation #42.var.src.temp.t2 42.obj.src.temp -= #42.var.src.temp.t1 42.obj.src.temp
...
execute if data storage 42:src temp_gun.components.minecraft:custom_data.42data.src.gun.cooldown.on_swap store result score @s 42.obj.src.gun.cooldown_time run data get storage 42:src temp_gun.components.minecraft:custom_data.42data.src.gun.cooldown.on_swap
