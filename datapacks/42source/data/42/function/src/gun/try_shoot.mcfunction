...
execute if data storage 42:src temp_gun.components.minecraft:custom_data.42components.src.gun.cooldown.on_shoot store result score @s 42.obj.src.gun.cooldown_time run data get storage 42:src temp_gun.components.minecraft:custom_data.42components.src.gun.cooldown.on_shoot
...
# summon bullet
execute anchored eyes positioned ^ ^-.25 ^.5 run summon item_display ~ ~ ~ {Tags:["42.tag.src.gun.bullet.marker","42.tag.src.new_spawn"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],scale:[.0625f,.0625f,.0625f],translation:[0f,0f,0f]},teleport_duration:1}
scoreboard players set @e[limit=1,type=item_display,tag=42.tag.src.new_spawn] 42.obj.datapack 7
...
execute if data storage 42:src temp_gun.components.minecraft:custom_data.42components.src.gun.bullet.item run data modify entity @e[limit=1,type=item_display,tag=42.tag.src.new_spawn] item set from storage 42:src temp_gun.components.minecraft:custom_data.42components.src.gun.bullet.item
