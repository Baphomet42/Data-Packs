...
attribute @s minecraft:movement_speed modifier add 42:dbd_move_scale .25 add_multiplied_total

# this attribute should set the minecraft walking speed to be 4.0 m/s (100% dbd speed)
# calculated with (4/4.317)-1
attribute @s minecraft:movement_speed modifier add 42:dbd_move_base -.0734 add_multiplied_total