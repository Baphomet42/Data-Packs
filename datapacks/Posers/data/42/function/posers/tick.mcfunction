...
execute as @e[type=mannequin,tag=42.tag.posers.mannequin,tag=42.tag.posers.mannequin.ai.watch_player] at @s run function 42:posers/mannequin/ai/watch_player
