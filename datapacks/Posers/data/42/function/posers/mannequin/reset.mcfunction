...
summon interaction ~ ~ ~ {Tags:["42.tag.posers.new_spawn","42.tag.posers.mannequin.interaction_spacer","42.tag.posers.mannequin.rider"],data:{42data:{datapack:{}}},width:0,height:0,Rotation:[0f,-90f],Passengers:[{id:"interaction",Tags:["42.tag.posers.new_spawn","42.tag.posers.mannequin.interaction","42.tag.posers.mannequin.rider"],data:{42data:{datapack:{},posers:{mannequin_interaction:{}}}},width:0,height:0,response:true,Rotation:[0f,90f]}]}
