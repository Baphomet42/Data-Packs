...
summon interaction ~ ~ ~ {Tags:["42.tag.posers.new_spawn","42.tag.posers.mannequin.interaction_spacer","42.tag.posers.mannequin.rider","42.tag.posers.mannequin.group"],width:0,height:0,Rotation:[0f,-90f],Passengers:[{id:"interaction",Tags:["42.tag.posers.new_spawn","42.tag.posers.mannequin.interaction","42.tag.posers.mannequin.rider","42.tag.posers.mannequin.group"],width:0,height:0,response:true,Rotation:[0f,90f]}]}
