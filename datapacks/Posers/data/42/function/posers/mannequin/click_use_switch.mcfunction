...
execute as @e[type=interaction,tag=42.tag.posers.temp_interaction] on vehicle on vehicle run return run function 42:posers/mannequin/editor/original/edit_equipment