...
item modify entity @e[type=item,tag=42.tag.posers.new_spawn,limit=1,x=0] contents [{type:"set_name",target:"item_name",entity:"this",name:{storage:"42:posers",nbt:"temp.item.Item.components.minecraft:item_name",interpret:true}},{type:"set_lore",mode:"replace_section",offset:0,entity:"this",lore:[{storage:"42:posers",nbt:"temp.item.Item.components.minecraft:lore[0]",interpret:true}]}]
