...
execute at @s unless entity @e[type=mannequin,tag=42.tag.posers.mannequin.temp_editing,limit=1] run function 42:posers/mannequin/editor/original/edit_equipment_end_range
# TODO distance based on scale
# execute on vehicle at @s unless entity @a[distance=..10] run function 42:posers/mannequin/editor/original/edit_equipment_end_range
