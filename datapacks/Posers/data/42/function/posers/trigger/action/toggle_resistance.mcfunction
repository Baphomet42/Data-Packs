...
execute if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:effects":{"minecraft:resistance":{amplifier:255,duration:-1,visible:false,ambient:false}}}} run tag @s add 42.tag.posers.temp_toggle
