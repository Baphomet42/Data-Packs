tellraw @s[scores={42menu=1}] [{text:""},{text:"Posers",color:"gold",bold:true},{text:"\n   "},{text:"Get item...",color:"dark_gray"},{text:"\n      "},{text:"[",extra:[[{translate:"entity.minecraft.mannequin"}," Poser"],"]"],color:"gray",click_event:{action:"run_command",command:"/trigger 42menu set 4209001"}}]
#4209001-4209002
...
execute if entity @s[scores={42menu=4209001}] run function 42:posers/mannequin/spawn_egg/give_random_texture