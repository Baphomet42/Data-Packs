...
execute unless data storage 42:config settings.labs{autoteam:1b} unless data storage 42:config settings.labs{autoteam:0b} run data modify storage 42:config settings.labs.autoteam set value 0b
