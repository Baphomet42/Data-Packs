...
# essentials
summon item ~ ~ ~ {Item:{components:{"minecraft:custom_name":{color:"gold",extra:[{bold:true,color:"white",text:"Essentials"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""},"minecraft:item_name":{color:"gold",extra:[{bold:true,color:"white",text:"Essentials"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""}},count:1,id:"minecraft:white_shulker_box"}}

# black magick
summon item ~ ~ ~ {Item:{components:{"minecraft:custom_name":{color:"gold",extra:[{bold:true,color:"#420666",text:"Magick"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""},"minecraft:item_name":{color:"gold",extra:[{bold:true,color:"#420666",text:"Magick"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""}},count:1,id:"minecraft:black_shulker_box"}}

# potions
summon item ~ ~ ~ {Item:{components:{"minecraft:custom_name":{color:"gold",extra:[{bold:true,color:"yellow",text:"Potions"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""},"minecraft:item_name":{color:"gold",extra:[{bold:true,color:"yellow",text:"Potions"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""}},count:1,id:"minecraft:yellow_shulker_box"}}
...
# heads
summon item ~ ~ ~ {Item:{components:{"minecraft:custom_name":{color:"gold",extra:[{bold:true,color:"gray",text:"Heads"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""},"minecraft:item_name":{color:"gold",extra:[{bold:true,color:"gray",text:"Heads"}," [",{italic:true,text:"BaphomethLabs"},"]"],italic:false,text:""}},count:1,id:"minecraft:light_gray_shulker_box"}}
