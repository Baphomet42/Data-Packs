...
data remove storage 42:io data.output.components.!minecraft:swing_animation
...
execute if items entity 42146f6d-d83f-4161-a8c7-e97d9621731a contents *[swing_animation={}] run data modify storage 42:io data.output.components.minecraft:swing_animation set value {}
